    ...
    <View style={styles.listItemShadow}>
      {props.is_edit === false ? <TouchableOpacity style={styles.listItem} onPress={() => navigation.push('ViewPost', 
        ...
        <View style={styles.listItemFooter}>
              <Text numberOfLines={2} style={[ text_styles.medium, { fontWeight: "600", flex: 4 } ]}>{post.is_buy == false ? null : <Text numberOfLines={2} style = {[ text_styles.medium, { color: '#0f4d92', flex: 4 } ]}>Buying: </Text>}{post.title}</Text>
