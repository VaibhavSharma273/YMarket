    ...
    return (
        <View style={styles.container}>
            <View style={styles.info_container}>
                {!is_post ? <View style={{ marginVertical: 20, height: 1, width: '80%' }} /> : null}
                <View style={{ flexDirection: 'row' }}>
                    ...
                    >
                        ...
                        <Text numberOfLines={1} adjustsFontSizeToFit style={styles.contact}>
                            {user.email}
                        </Text>
                        <Text numberOfLines={2} adjustsFontSizeToFit style={styles.bio}>
                            {user.bio ? <>{user.bio.length < 42 ? user.bio : `${user.bio.substring(0, 42)}...`}</> : ''}
                        </Text>
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() =>
                            navigation.navigate('EditUserProfile', {
                                initialValues: user,
                                updateCallback: updateUserProfile,
                            })
                        }
                    >
